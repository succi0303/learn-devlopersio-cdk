...
export class RouteTable extends Resource {
  ...
  private createAssociation(scope: cdk.Construct, assocationInfo: AssociationInfo, routeTable: CfnRouteTable) {
    new CfnSubnetRouteTableAssociation(scope, assocationInfo.id, {
      routeTableId: routeTable.ref,
      subnetId: assocationInfo.subnetId()
    });
  }
}