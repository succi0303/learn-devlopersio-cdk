...
export class Subnet {
	...
	public createResources(scope: cdk.Construct) {
		...
		this.public1a = new CfnSubnet(scope, 'SubnetApp1a', {
		...
		this.public1a = new CfnSubnet(scope, 'SubnetApp1c', {
		...
		this.public1a = new CfnSubnet(scope, 'SubnetDb1a', {
		...
		this.public1a = new CfnSubnet(scope, 'SubnetDb1c', {
