...
import { CfnSubnet, CfnSubnetCidrBlock, CfnVPC } from '@aws-cdk/aws-ec2';
import { Resource } from './abstract/resource';
import { Construct, ConstructOrder } from '@aws-cdk/core';
...
export class Subnet extends Resource {
	...
	private createSubnet(scope: cdk.Construct, resourceInfo: ResourceInfo): CfnSubnet {
		const subnet = new CfnSubnet(scope, resourceInfo.id, {
			...
			tags: [{ key: 'Name', value: this.createResourceName(scope, resourceInfo.resouceName) }]
		});
