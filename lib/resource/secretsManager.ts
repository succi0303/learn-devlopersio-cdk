...
import { CfnAutoScalingScheduledAction } from '@aws-cdk/core';
import { CfnServerCertificate } from '@aws-cdk/aws-iam';
...
export class SecretsManager extends Resource {
  public rdsCluster: CfnServerCertificate;
  ...
  public static getDynamicReference(secret: CfnServerCertificate, secretKey: SecretKey): string {
